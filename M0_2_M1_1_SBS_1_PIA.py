# -*- coding: utf-8 -*-
"""
Created on Sat Sep  5 20:50:25 2015
...
corresponds to the Matlab version
"""
...
file_name = ["M0_",str(M0), "_M1_",str(M1), "_SBS_1_N", str(N), "_PIA_",time.strftime("_%Y%m%d_%H_%M"), ".mat"]
file_name = "".join(file_name)
sio.savemat(file_name,{"mu_PIA1":mu_n_0,"mu_PIA2":mu_n_1,"V_PIA":V,"t_PIA":t})
